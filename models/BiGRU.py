...
data_train = pd.read_csv('/home/anavaleria/multiNLI/data/QA_data/QQ_train.csv', sep=',')
print data_train.shape

data_dev = pd.read_csv('/home/anavaleria/multiNLI/data/QA_data/QQ_dev.csv', sep=',')
print data_dev.shape


data_test = pd.read_csv('/home/anavaleria/multiNLI/data/QA_data/QQ_test.csv', sep=',')
...
GLOVE_DIR = "/home/anavaleria/multiNLI/data/"
embeddings_index = {}
...
if os.path.exists(filepath) == True:
    ...
    bestmodel.fit([x_train, org_train], y_train,
                ...
                nb_epoch=10, batch_size=240, verbose = 1,
    ...
    #l_gru11 = Bidirectional(GRU(600, return_sequences=False))(norm1)
    #norm11 = BatchNormalization()(l_gru11)
    ...
    #l_gru22 = Bidirectional(GRU(600, return_sequences=False))(norm2)
    #norm22 = BatchNormalization()(l_gru22)
    #l_att2 = AttLayer()(l_gru2)



    merged = concatenate([norm1, norm2])
    l_gru3 = Bidirectional(GRU(1200, return_sequences=False))(merged)
